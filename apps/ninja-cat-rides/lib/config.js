export default {
    ...
    sprites: {
        ...
        dino: { h: 114, w: 156, x: 907, y: 28 }, // left
        dinoDuckLeftLeg: { h: 104, w: 150, x: 1091, y: 38 }, // right
        dinoDuckRightLeg: { h: 104, w: 150, x: 1091, y: 38 }, // right
        dinoLeftLeg: { h: 114, w: 156, x: 907, y: 28 }, // left
        dinoRightLeg: { h: 104, w: 150, x: 1091, y: 38 }, // right
